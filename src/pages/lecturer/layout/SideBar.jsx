...
export function Sidebar() {
  ...
  const navigation = [
    { name: "Dashboard", to: "/lecturer/dashboard", icon: Home },
    { name: "Projects", to: "/lecturer/projects", icon: FileText },
    { name: "Explore", to: "/lecturer/explore", icon: BookOpen },
    { name: "Profile", to: "/lecturer/profile", icon: Users },
  ];
